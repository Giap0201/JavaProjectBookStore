...
//    private ArrayList<Employee> listEmployee;
    ...
    public SelectEmployeeView() {
        // Tạo một dialog không có cửa sổ cha, tiêu đề là "Chọn nhân viên", và sẽ chặn toàn bộ các cửa sổ khác cho đến khi người dùng đóng nó lại.
    ...
    public void display() {
        ...
        String[] columnNames = { "Mã NV", "Tên NV", "Chức vụ", "Phòng ban", "Số điện thoại", "Email" };
